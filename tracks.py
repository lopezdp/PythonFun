...
if ( len(fname) < 1 ) : fname = 'C.MusicLibraryPlist.xml'
...
for entry in all:
    ...
    if song is None or artist is None or album is None or genre is None : 
        continue

    print song, artist, album, genre, count, rating, length
